...
| 2.2 | [유니버스 선택 — 성과는 어디에 있는가](part2_2_universe_selection.md) | 엣지의 대부분은 일상 신호가 아니라 유니버스 표류 |
| 2.3 | [대조군 비교와 전략적 방향](part2_3_control_comparison.md) | 거래군 vs 대조군 · placebo 윈도우 · 이중차분 |
...
| 3.4 | [플랜에서 주문으로 — 승인 게이트 실행](part3_4_approval_gated_execution.md) | 제안 → 검토 → 실행 · HMAC 토큰 · fail-closed 거부권 |
