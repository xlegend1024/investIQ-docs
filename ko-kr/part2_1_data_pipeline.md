...
- 시스템은 다중 출처에서 수집합니다: Alpaca 시장 바, 그리고 news-intel이 종목별 감성으로 가공하는 멀티소스
  뉴스(RSS, Reddit, SEC 8-K).
...
*그림. 44거래일에 걸친 133종목 거래 유니버스의 종목 × 날짜 감성 커버리지. 채워진 셀은 격자의 일부입니다 —
뉴스는 본질적으로 희소합니다.*

![감성 분포](./images/01_sentiment_distribution.png)
*그림. 하루 지연된 일별 뉴스 감성의 분포. 상당수 종목-날짜가 중립(0) 감성을 가집니다 — 대부분의 날,
...
FIFO로 라운드트립에 매칭해 4편이 분석하는 실현 손익 — **927건의 마감 라운드트립에서 −$369.85** — 을 얻었습니다.
