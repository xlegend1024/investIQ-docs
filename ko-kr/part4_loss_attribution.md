...
- 계정의 **자본이 실험 기간 동안 ≈ −$878** 감소했습니다. 이는 **실현(롱+잔여 숏) −$452 + 미청산 미실현 −$339 + 수수료/슬리피지 −$88**로 분해됩니다.
...
이 기간의 결과는 하나의 숫자입니다: 현 시점 평가(mark-to-market) 기준으로 **계정 자본이 약 $878 감소했습니다.** (≈$25,000 → ≈$24,122). 
윈도우 동안 종목별로 매수를 매도에 FIFO 매칭해 얻은 **롱 전용 마감 라운드트립 실현손익 −$369.85**.
이는 *마감된 롱 거래만*을 측정한 값으로, 자기자본 변화 −$878의 일부일 뿐입니다. 나머지는 아래 세 구성요소에서 옵니다.
